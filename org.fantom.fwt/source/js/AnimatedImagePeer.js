 ...
 * AnimatedImagePeer.
 */
fan.fwt.AnimatedImagePeer = fan.sys.Obj.$extend(fan.fwt.WidgetPeer);
fan.fwt.AnimatedImagePeer.prototype.$ctor = function(self) {}

fan.fwt.AnimatedImagePeer.prototype.m_text = "";
fan.fwt.AnimatedImagePeer.prototype.text   = function(self) { return this.m_text; }
fan.fwt.AnimatedImagePeer.prototype.text$  = function(self, val)
{
  this.m_text = val;
  this.needRebuild = true;
}

fan.fwt.AnimatedImagePeer.prototype.m_bg = null;
fan.fwt.AnimatedImagePeer.prototype.bg   = function(self) { return this.m_bg; }
fan.fwt.AnimatedImagePeer.prototype.bg$  = function(self, val)
{
  this.m_bg = val;
  this.needRebuild = true;
}

fan.fwt.AnimatedImagePeer.prototype.m_fg = null;
fan.fwt.AnimatedImagePeer.prototype.fg   = function(self) { return this.m_fg; }
fan.fwt.AnimatedImagePeer.prototype.fg$  = function(self, val)
{
  this.m_fg = val;
  this.needRebuild = true;
}

fan.fwt.AnimatedImagePeer.prototype.m_font = null;
fan.fwt.AnimatedImagePeer.prototype.font   = function(self) { return this.m_font; }
fan.fwt.AnimatedImagePeer.prototype.font$  = function(self, val)
{
  this.m_font = val;
  this.needRebuild = true;
}

fan.fwt.AnimatedImagePeer.prototype.m_halign = null;
fan.fwt.AnimatedImagePeer.prototype.halign   = function(self) { return this.m_halign; }
fan.fwt.AnimatedImagePeer.prototype.halign$  = function(self, val)
{
  this.m_halign = val;
  this.needRebuild = true;
}

fan.fwt.AnimatedImagePeer.prototype.m_image = null;
fan.fwt.AnimatedImagePeer.prototype.image  = function(self) { return this.m_image; }
fan.fwt.AnimatedImagePeer.prototype.image$ = function(self, val)
{
  this.m_image = val;
  if (val != null)
  {
...
fan.fwt.AnimatedImagePeer.prototype.create = function(parentElem, self)
{
  this.needRebuild = true; // make sure we force rebuild
  return fan.fwt.WidgetPeer.prototype.create.call(this, parentElem, self);
}

fan.fwt.AnimatedImagePeer.prototype.sync = function(self)
{
...
fan.fwt.AnimatedImagePeer.prototype.needRebuild = true;
fan.fwt.AnimatedImagePeer.prototype.rebuild = function(self)
{
...
fan.fwt.AnimatedImagePeer.prototype.$hgap = function(self) { return null; }

// Backdoor hook to override soft clipping [returns Bool]
fan.fwt.AnimatedImagePeer.prototype.$softClip = function(self) { return false; }

// Backdoor hook to override image size [returns Size?]
fan.fwt.AnimatedImagePeer.prototype.$imageSize = function(self) { return null; }

// Backdoor hook to override text style [returns [Str:Str]?]
fan.fwt.AnimatedImagePeer.prototype.$style = function(self) { return null; }

// Backdoor hook to reuse Label for hyperlinks
// { uri:<encoded-uri>, underline:<css-underline>" }
fan.fwt.AnimatedImagePeer.prototype.$uri = function(self) { return null; }
