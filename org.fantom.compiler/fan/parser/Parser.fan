...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  private Void skipUsing()
  {
    ...
    consumeId
    while (curt === Token.dot) { consume; consumeUsingId }
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  public static Bool isValidInUsing(Token t) {
    return t === Token.identifier 
        || t === Token.internalKeyword 
        || t === Token.asKeyword
        || t === Token.isKeyword
        || t === Token.isnotKeyword
        || t === Token.itKeyword
        || t === Token.mixinKeyword
        || t === Token.onceKeyword
        || t === Token.overrideKeyword
        || t === Token.readonlyKeyword
        || t === Token.virtualKeyword
        || t === Token.usingKeyword
  }
  
  private Str consumeUsingId()
  {
    if (!isValidInUsing(curt))
      throw err("Expected identifier, not '$cur'")
    id := consume
    return id.kind === Token.identifier ? (Str)id.val : id.kind.toStr()
  }
